...
display: flex;
  font-weight: 600;
  font-size: ${(props) => (props.main ? "55px" : "35px")};
  line-height: ${(props) => (props.main ? "60px" : "35px")};
  width: max-content;
  max-width: 100%;
  background: linear-gradient(
    121.57deg,
...
export const SectionText = styled.p`
  ...
  background: linear-gradient(
    121.57deg,
    rgb(251, 157, 251) 18.77%,
    rgb(213, 249, 121) 60.15%
  );
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
...
export const SectionDivider2 = styled.div`
  ...
  height: 30px;
  width: 30px;
  clip-path: polygon(0% 0%, 0% 100%, 13% 100%, 11% 10%, 89% 10%, 89% 90%, 14% 90%, 9% 100%, 100% 100%, 100% 0%);
